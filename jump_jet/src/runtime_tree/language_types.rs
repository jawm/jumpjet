...
//    pub data: RefMut<'a, ModuleInstanceData>,
//    pub locals: &'a mut Vec<ValueTypeProvider>,
//    pub stack: &'a mut Vec<ValueTypeProvider>
//}
//
//pub trait Execute {
...
//                    let &TypeDefinition::Func(ref signature) = &(stack_frame.data.types)[idx];
//                    let mut args = vec![];
...
//                        let &Table::AnyFunc{ref limits, ref values} = &(stack_frame.data.tables)[0];
//                        let fn_index = values.get(index as usize).unwrap();
//                        let callable = stack_frame.data.functions.get(*fn_index).unwrap();
//                        let mut data = stack_frame.data;
...
//                    });
//                },
//                Operation::GetLocal(idx) => stack.push(stack_frame.locals[idx].clone()),
...
//                    }
//                },
//                Operation::GetGlobal(idx) => stack.push(stack_frame.data.globals[idx].clone()),
